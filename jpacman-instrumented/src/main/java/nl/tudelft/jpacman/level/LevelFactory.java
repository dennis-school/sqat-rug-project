...
import nl.tudelft.jpacman.sprite.Sprite; import static nl.dennis.api.CoverageChecker.hit; public class LevelFactory {
	...
	public Level createLevel(Board board, List<NPC> ghosts,
			List<Square> startPositions) {hit("nl.tudelft.jpacman.level.LevelFactory","createLevel"); hit("nl.tudelft.jpacman.level.LevelFactory","createLevel",1); CollisionMap collisionMap = new PlayerCollisions(); hit("nl.tudelft.jpacman.level.LevelFactory","createLevel",2); return new Level(board, ghosts, startPositions, collisionMap);}
	 ...
	 */
	public Pellet createPellet() {hit("nl.tudelft.jpacman.level.LevelFactory","createPellet"); hit("nl.tudelft.jpacman.level.LevelFactory","createPellet",1); return new Pellet(PELLET_VALUE, sprites.getPelletSprite());}
