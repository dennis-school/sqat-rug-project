...
import nl.tudelft.jpacman.sprite.Sprite; import static nl.dennis.api.CoverageChecker.hit; public abstract class Square {
	 ...
	 */
	public Square getSquareAt(Direction direction) {hit("nl.tudelft.jpacman.board.Square","getSquareAt"); hit("nl.tudelft.jpacman.board.Square","getSquareAt",1); return neighbours.get(direction);}
	 ...
	 */
	public void link(Square neighbour, Direction direction) {hit("nl.tudelft.jpacman.board.Square","link"); hit("nl.tudelft.jpacman.board.Square","link",1); neighbours.put(direction, neighbour); hit("nl.tudelft.jpacman.board.Square","link",2); assert invariant(); hit("nl.tudelft.jpacman.board.Square","link",3);}
	 ...
	 *         which they occupied this square (i.e. oldest first.)
	 */
	public List<Unit> getOccupants() {hit("nl.tudelft.jpacman.board.Square","getOccupants"); hit("nl.tudelft.jpacman.board.Square","getOccupants",1); return ImmutableList.copyOf(occupants);}
